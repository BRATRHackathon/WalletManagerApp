...
namespace WalletManagerApp
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            client.UseDefaultCredentials = bool.Parse(ConfigurationManager.AppSettings["EmailDefaultCredentials"]);
            client.EnableSsl = bool.Parse(ConfigurationManager.AppSettings["EmailSSL"]);
            ...
            {
                Body = message.Body,
                From = new MailAddress(ConfigurationManager.AppSettings["SupportEmailAddr"], "Support"),
                IsBodyHtml = true,
